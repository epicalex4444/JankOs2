...
pub static mut BITMAP: Bitmap = Bitmap {
...
pub fn init_paging(
    ...
    for i in 0..memory_map_entries {
        unsafe {
            let descriptor: *const EFI_MEMORY_DESCRIPTOR =
                (memory_map as u64 + i * descriptor_size) as *const EFI_MEMORY_DESCRIPTOR;
    ...
    for i in 0..memory_map_entries {
        unsafe {
            ...
            if (*descriptor).r#type == 7
                && (*descriptor).number_of_pages >= bitmap_pages
